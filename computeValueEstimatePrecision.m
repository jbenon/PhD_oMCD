% Computes the precision of the absolute difference between estimated
% values, as the inverse of the variance, depending on the number of
% attributes sampled.

function precision = computeValueEstimatePrecision(DataSamples, ...
    states)
% Parameters
% ----------
...
% Outputs
% -------
% precision: [1 x n_samples] double
%   Precision of the absolute difference between option values.
...
for i_trial = 1:n_trials
    ...
    for i_step = 1:3
        ...
        precision(i_sample) = 1 / var(abs_value_diff, 1);
    end
end
