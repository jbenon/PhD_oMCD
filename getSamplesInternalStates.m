...
% which attribute has been sampled and what is the rank of known
% attributes.

function states = getSamplesInternalStates(CueSamples)
% Parameters
% ----------
...
for i_trial = 1:n_trials
    ...
    for i_step = 1:4
        ...
        states(1, i_sample) = known_cue_ranks(1);
        % Update estimated left magnitude
        states(2, i_sample) = known_cue_ranks(2);
        % Update estimated right probability
        states(3, i_sample) = known_cue_ranks(3);
        % Update estimated right magnitude
        states(4, i_sample) = known_cue_ranks(4);
    end
end
